...
#     ax.set_xticklabels(cm.dendrogram_col.reordered_ind, rotation=0)
#     ax.set_yticks(np.arange(data.shape[0]))
#     ax.set_yticklabels(cm.dendrogram_row.reordered_ind)
#     ax.set_title(stimuli_files[i][:-4], pad=10)
...
# label_fontsize = 8  # Adjust this value to change the size of x-axis and y-axis labels
...
#     ax.imshow(cm.data2d, cmap="coolwarm", vmin=-1, vmax=1)
#     ax.set_xticks(np.arange(data.shape[1]))
#     ax.set_xticklabels(cm.dendrogram_col.reordered_ind, rotation=-90, fontsize=label_fontsize)
#     ax.set_yticks(np.arange(data.shape[0]))
#     ax.set_yticklabels(cm.dendrogram_row.reordered_ind, fontsize=label_fontsize)
#     ax.set_title(stimuli_files[i][:-4], pad=10, fontsize=title_fontsize)
