...
G1, node_colors1 = create_graph(
    coordinates, neuron_activity, corr_threshold_1, period1, period2, activity_threshold
)
...
G2, node_colors2 = create_graph(
    coordinates, neuron_activity, corr_threshold_2, period1, period2, activity_threshold
)
